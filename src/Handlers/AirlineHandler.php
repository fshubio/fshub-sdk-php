...
class AirlineHandler extends BaseFeatureHandler
{
    ...
    /**
     * Sets the airline context from an implementation of AirlineInterface.
     * @param AirlineInterface $airline The airline entity
     * @return AirlineHandler
     */
    public function selectByEntity(AirlineInterface $airline): AirlineHandler
    {
        $this->selectedId = $airline->getAirlineId();
        return $this;
    }
    ...
    public function first(int $id): Airline
    {
        return Airline::fromJson(
            $this->connector->get("airline/{$id}")->body
        );
    }
    ...
    public function get(): Airlines
    {
        return Airlines::fromJson(
            $this->connector->get("airline?cursor={$this->cursor}&limit={$this->limit}")->body
        );
    }
    ...
    public function stats(): AirlineStats
    {
        ...
        return AirlineStats::fromJson(
            $this->connector->get("airline/{$this->selectedId}/stats")->body
        );
    }
    ...
    public function pilots(): Pilots
    {
        ...
        return Pilots::fromJson(
            $this->connector->get("airline/{$this->selectedId}/pilot?cursor={$this->cursor}&limit={$this->limit}")->body
        );
    }
    ...
    public function arrivals(string $icao): Flights
    {
        ...
        return Flights::fromJson(
            $this->connector->get("airline/{$this->selectedId}/arrival/{$icao}?cursor={$this->cursor}&limit={$this->limit}")->body
        );
    }
    ...
    public function departures(string $icao): Flights
    {
        $this->requiresSetContext($this->selectedId);
        return Flights::fromJson(
            $this->connector->get("airline/{$this->selectedId}/departure/{$icao}?cursor={$this->cursor}&limit={$this->limit}")->body
        );
    }
    ...
    public function route(string $departure, string $arrival): Flights
    {
        $this->requiresSetContext($this->selectedId);
        return Flights::fromJson(
            $this->connector->get("airline/{$this->selectedId}/departure/{$departure}/arrival/{$arrival}?cursor={$this->cursor}&limit={$this->limit}")->body
        );
    }
    ...
    public function screenshots(): Screenshots
    {
        ...
        return Screenshots::fromJson(
            $this->connector->get("airline/{$this->selectedId}/screenshot?cursor={$this->cursor}&limit={$this->limit}")->body
        );
    }
}
