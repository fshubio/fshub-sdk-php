...
class TestConnector implements FsHubConnectorInterface
{
    public function Get(string $resourceIdentifier): ConnectorResponse
    {
        return match ($resourceIdentifier) {
            ...
            "airline/1778/departure/EGSS/arrival/LOWS?cursor=0&limit=10" => $this->AirlineRoutes(1033, "EGSS", "LOWS"),
            "airline/1778/departure/EGSS/arrival/LPPT?cursor=0&limit=10" => $this->AirlineRoutesNoneFound(1033, "EGSS",
                "LPPT"),
